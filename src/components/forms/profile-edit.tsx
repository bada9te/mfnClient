...
import { useUserLinkGoogleMutation, useUserPrepareAccountToRestoreMutation, useUserSuspenseQuery, useUserUnlinkFacebookMutation, useUserUnlinkGoogleMutation, useUserUnlinkTwitterMutation, useUserUpdateMutation } from "@/utils/graphql-requests/generated/schema";
        ...
        <div className="card overflow-hidden bg-base-300 shadow-xl glass rounded-2xl md:rounded-2xl mx-2 md:mx-0">
            <div className="bg-base-300 card-body m-1 pulsar-shadow text-white md:rounded-2xl shadow-2xl glass">
                ...
                <div className="flex w-full flex-wrap gap-4">
                    ...
                    <div className="join join-horizontal w-full">
                        <Link href={envCfg.googleAuthURL as string} className={`btn w-[calc(100%-60px)] join-item glass hover:bg-white text-black ${userData.user.google?.email && 'bg-white/80 text-black'}`}>
