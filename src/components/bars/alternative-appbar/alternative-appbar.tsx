    ...
    return (
        <div className="bg-base-300 min-h-full min-w-full rounded-2xl overflow-hidden p-2 relative flex flex-col gap-3">
            ...
            <div className="h-full flex flex-col justify-between">
                ...
                <ul 
                    tabIndex={0}      
                    className="w-full bg-neutral text-base-content menu menu-sm dropdown-content max-h-[460px] overflow-y-auto no-scrollbar z-[1] p-2 shadow rounded-box flex flex-col flex-nowrap"
                >
                    <li>
                        <Link href={"/feed/1"}>
                            <Earth/>
                    ...
                    <li>
                        <details>
                            ...
                            <div className="flex flex-row flex-wrap gap-2 p-3">
                                <div className="badge "><Link href={"/categories/country/1"}>Country</Link></div>
                                <div className="badge "><Link href={"/categories/pop/1"}>Pop</Link></div>
                                <div className="badge "><Link href={"/categories/classical/1"}>Classical</Link></div>
                                <div className="badge "><Link href={"/categories/funk/1"}>Funk</Link></div>
                                <div className="badge "><Link href={"/categories/soul/1"}>Soul</Link></div>
                                <div className="badge "><Link href={"/categories/hip-hop/1"}>Hip hop</Link></div>
                                <div className="badge "><Link href={"/categories/rock/1"}>Rock</Link></div>
                                <div className="badge "><Link href={"/categories/electronic/1"}>Electronic</Link></div>
                                <div className="badge "><Link href={"/categories/latin/1"}>Latin</Link></div>
                                <div className="badge "><Link href={"/categories/jazz/1"}>Jazz</Link></div>
                                <div className="badge "><Link href={"/categories/blues/1"}>Blues</Link></div>
                                <div className="badge "><Link href={"/categories/folk/1"}>Folk</Link></div>
                                <div className="badge "><Link href={"/categories/metal/1"}>Metal</Link></div>
                                <div className="badge "><Link href={"/categories/reggae/1"}>Reggae</Link></div>
                            </div>
                        </details>
                    </li>
                </ul>
