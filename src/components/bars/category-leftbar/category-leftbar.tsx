...
export default function CategoryLeftBar(props: {
    ...
    return (
        <div className={`card w-fit max-w-[305px] min-h-48 bg-cover bg-center bg-base-300 shadow-none text-white max-h-52 relative bg-opacity-80 rounded-2xl overflow-hidden`}>
            ...
            <div className="card-body relative">
                ...
                <div className="absolute top-0 right-0 h-full card-actions justify-end p-1">
                    <Link className="btn btn-primary glass h-full btn-sm text-white rounded-2xl" href={`/categories/${String(title).toLowerCase().replaceAll(' ', '-')}/1`}>
