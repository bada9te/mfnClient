export default function LeftBarDrawer() {
    return (
        <div className="drawer">
            <input id="my-drawer-tracks" type="checkbox" className="drawer-toggle"/>
            <div className="drawer-content">
                {/* Page content here */}
                <label htmlFor="my-drawer-tracks" className="drawer-button cursor-pointer flex flex-col justify-center items-center text-center">
