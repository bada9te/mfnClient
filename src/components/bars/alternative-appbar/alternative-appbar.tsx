...
export default function AlternativeAppbar({
    ...
    return (
        <div className="bg-base-300 min-h-full min-w-full rounded-2xl overflow-hidden p-2 bg-opacity-80 relative flex flex-col gap-3">
            <Link className="btn btn-ghost glass w-full h-fit text-base-content p-3" href={'/'}>
            ...
            <div className="h-full flex flex-col justify-between">
                ...
                <ul 
                    tabIndex={0}      
                    className="w-full bg-neutral text-white menu menu-sm dropdown-content max-h-[460px] overflow-y-auto no-scrollbar z-[1] p-2 shadow rounded-box flex flex-col flex-nowrap bg-opacity-80"
                >
                    <li>
                        <Link href={"/feed/1"}>
                            <Earth/>
                    ...
                    <li>
                        <details>
                            ...
                            <ul className="p-3 text-white shadow-none">
                    ...
                    <li>
                        <details>
                            ...
                            <ul className="p-2 text-white shadow-none">
