...
export default function SwitchLocaleModal({button, dictionary}: {button: React.ReactElement; dictionary: Awaited<ReturnType<typeof getDictionary>>["components"]}) {
    ...
    const handleSelectLocale = (locale: TLang) => {
            ...
            <dialog ref={ref} className="modal w-full cursor-default">
                ...
                <div className="modal-box text-gray-300 max-w-[350px] w-[100vw] h-fit md:max-w-[600px] md:w-[600px] no-scrollbar text-start flex flex-col">
                    ...
                    <div className="w-full h-full flex items-center justify-center">
                        <div className="mt-4 flex flex-row gap-3 flex-wrap items-center justify-center max-h-[400px] max-w-[375px] overflow-y-auto no-scrollbar">
                            <SwitchLocaleItem 
                                title="English" 
                                locale="en" 
                                selected={selectedLocale}
                                localeDescription="US" 
