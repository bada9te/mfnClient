...
export default function PostItem(props: {
    ...
    // handle likes
    const onLikesChanged = async(_: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
    ...
    const switchPostInSaved = async(_: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
        if (addons.status === "upload") return;
