...
export default function Page() {
    return (
        <>
            <div className="flex flex-col items-center text-white py-10 m-0 md:mx-4 md:mt-4 border-none bg-base-300 rounded-2xl relative bg-opacity-80">
            ...
            <div className="flex flex-col items-center text-white py-10 m-0 md:mx-4 md:mt-4 border-none relative bg-base-300 rounded-2xl bg-opacity-80">
