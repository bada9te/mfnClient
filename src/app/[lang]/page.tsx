...
export default async function Page({params}: {params: {lang: TLang}}) {
    ...
    return (
        <>
            {/* ONE */}
            <div className="overflow-hidden flex flex-col items-center text-white m-2 mt-6 md:mx-4 md:mt-4 border-none bg-base-300 rounded-2xl relative bg-opacity-80 min-h-[600px] max-w-[calc(100vw-17px)] md:max-w-[calc(100vw-150px)] lg:max-w-[calc(100vw-475px)]">
            ...
            {/* TWO */}
            <div className="overflow-hidden flex flex-col items-center text-white py-10 m-2 md:mx-4 md:mt-4 border-none relative bg-base-300 rounded-2xl bg-opacity-80 max-w-[calc(100vw-17px)] md:max-w-[calc(100vw-150px)] lg:max-w-[calc(100vw-475px)]">
                <DotPattern
                    className={cn(
            ...
            {/* THREE */}
            <div className="py-10 m-2 md:mx-4 md:mt-4 border-none bg-base-300 rounded-2xl bg-opacity-80 max-w-[calc(100vw-17px)] md:max-w-[calc(100vw-150px)] lg:max-w-[calc(100vw-475px)]">
                <MarqueeDemo dictionary={dict.app}/>
            </div>

            
            {/* FOUR */}
            <div className="overflow-hidden flex flex-col items-center text-white py-20 md:py-40 lg:py-56 m-2 md:mx-4 md:mt-4 border-none bg-base-300 rounded-2xl relative bg-opacity-80 max-w-[calc(100vw-17px)] md:max-w-[calc(100vw-150px)] lg:max-w-[calc(100vw-475px)]">
                <DotPattern
                    className={cn(
                    "[mask-image:radial-gradient(800px_circle_at_center,white,transparent)]",
                    )}
