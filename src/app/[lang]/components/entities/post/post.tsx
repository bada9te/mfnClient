...
export default function Post(props: {
    ...
    return (
        <div className={`card w-fit md:${fullWidth ? 'w-full' : 'w-80 max-w-80'} min-h-[360px] bg-base-100 shadow-xl max-h-fit text-base-content rounded-xl relative overflow-hidden`}>
