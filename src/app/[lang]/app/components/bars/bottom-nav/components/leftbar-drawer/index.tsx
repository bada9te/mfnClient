...
import Post from "@/app/[lang]/app/components/entities/post/post";
        ...
        <div className="drawer">
            ...
            <div className="drawer-side py-16 md:pb-16 md:pt-0 z-30 no-scrollbar">
                ...
                >
                    ...
                    <label className="input input-sm input-bordered flex items-center justify-between gap-2 my-2 bg-base-100">
