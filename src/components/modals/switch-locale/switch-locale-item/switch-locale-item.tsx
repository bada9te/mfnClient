...
export default function SwitchLocaleItem({locale, handleSelect, selected, title, localeDescription, svg}: {
    ...
    return (
        <div className={`card w-full md:w-[150px] shadow-xl rounded-xl ${selected === locale ? 'bg-base-100' : 'bg-base-300'} hover:bg-base-100 cursor-pointer glass`} onClick={() => handleSelect(locale)}>
